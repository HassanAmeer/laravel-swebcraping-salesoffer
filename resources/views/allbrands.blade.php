...
<script>
    ...
    inputBox.onkeyup = (e) => {
        ...
        if (userData) {
            ...
            request = $.ajax({
                ...
                type: "post",
                data: {
                    "_token": "8MOY5e5xieo6WChQQTLVTSYZyxLrmy5qGOoxPfLn",
                    'search': userData,
                }
            });
    ...
    <div class="w-100 py-2 px-2">
        ...
        <div class="container mx-auto">
            <div class="block my-5">
                                ...
                                <!--<a href="https://instagram.com/stylinchic_official?referrer=saleboard&type=banner&code=AC-1" rel="nofollow" target="_blank" width="600">-->
   ...
   <div class="wrapper">
     <h1 class="font-bold text-lg mb-10" style="color:green"> Brands </h1>
     <div class="flex flex-wrap"> 
      <!-- <div class="scrolls"> -->
     @foreach($popularbrandslist as $key)
        <div class="lg:w-1/6 mb-2 md:w-1/1 border-0  ml-0 sm:w-1/2" style="width: 7rem ">
        <a href="<?php echo route('vallsalesbybrandid', ['id' => substr($key['brandslink'],8)]) ?>" class="mb-4">

        <img class=" rounded shadow-lg mx-auto" src="{{$key['brandsimage']}}" style="width: 6em; height: 6em;">
        <div class=" py-4">
        <div class="">
        <div class="" style="">
        <p class="font-semibold truncate text-center">{{$key['brandsname']}} </p>
        </div> </div></div> </a> </div>
     @endforeach
    </div>   
    ...
    <!-- <h1 class="font-bold text-lg" style="color:orange"><a href="https://saleboard.pk/category/home"> Others Categories </a></h1> -->
    
    <!-- <div class="flex flex-wrap mt-2" style=" padding-top: 1.2em; padding-bottom: 1.2em">
        foreach($catglist as $key)
            <a href="" class="mb-4 mr-1 rounded-full font-semibold" style="text-transform:capitalize; background: rgb(66 56 157 / 15%); padding: .6em 1em; color: #42389d;">
                $key['catgname']
            </a>
            endforeach
    </div> -->
...
<script>
        $(".aiClick").click(function () {
            ...
            $.ajax({
                ...
                cache: false,
                headers: {
                    'X-CSRF-Token': '8MOY5e5xieo6WChQQTLVTSYZyxLrmy5qGOoxPfLn',
                },
...
<div id="pip-toast"></div><iframe id="_hjSafeContext_20658807" title="_hjSafeContext" tabindex="-1" aria-hidden="true" src="about:blank" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe></body></html>