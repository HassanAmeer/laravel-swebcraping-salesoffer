...
<html lang="en"><head>
    ...
    <!-- <meta name="csrf-token" content="4BzzBXONuOvLlFvyCB1gm6SSeLxZIm0Z6pfQAVtj"> -->
    ...
    <script async="" src="https://www.clarity.ms/s/0.7.8/clarity.js"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-T993Z9H"></script><script async="" src="https://www.clarity.ms/tag/746nuif8yy"></script><script defer="" src="https://use.fontawesome.com/releases/v5.3.1/js/all.js"></script>
    ...
    </script><script async="" src="https://static.hotjar.com/c/hotjar-2328207.js?sv=6"></script>
...
<script async="" src="https://script.hotjar.com/modules.92ff9978854791af68a7.js" charset="utf-8"></script></head>
<body>
...
<div class="w-full text-gray-700" style="background-color: #5b52a2; position: sticky; top: 0; z-index: 1;">
    <div x-data="{ open: false }" class="flex flex-col max-w-screen-2xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
            ...
            <a class="px-4 py-2 mt-2 text-sm text-white  md:mt-0" href="<?php echo route('vallcatgpage') ?>">Categories</a>
            <a class="px-4 py-2 mt-2 text-sm text-white  md:mt-0" href="<?php echo route('vallbrandspage') ?>">Brands</a>
    ...
    inputBox.onkeyup = (e) => {
        ...
        if (userData) {
            ...
            request = $.ajax({
                ...
                type: "post",
                data: {
                    "_token": "4BzzBXONuOvLlFvyCB1gm6SSeLxZIm0Z6pfQAVtj",
                    'search': userData,
                }
            });
            ...
            request.done(function (response, textStatus, jqXHR) {
                ...
                emptyArray = response['categories'].map((data) => {
                    ...
                    return data = '<li><a href="<?php echo route('vallcatgpage') ?>">' + capitalize(data['name']) + ' <small class="typeof">Category</small></a></li>';
                });
        ...
        <div class="container mx-auto">
            ...
            <div class="wrapper">
                <div>
                    ...
                    <a href="" class="float-right mt-0.5">What's on sale</a>
                </div>
                <div class="scrolls"> 
                    
                @foreach($featuredsaleslist as $key)
                 <div class="lg:w-1/4 mb-2 mr-2 md:w-1/1 border-0 rounded border-0 shadow-lg border-gray-300 ml-0 sm:w-1/2 border promotionCards " style=" height: auto;  width: 17.8rem; margin-bottom: 2% !important;">
                <!-- <a href="<?php echo $key['detailslink']; ?>" class="mb-4"> -->
                <a href="<?php echo route('vdetailsbyid', ['id' => substr($key['detailslink'],1)]) ?>" class="mb-4">
                <img class=" mx-auto w-52 rounded-t" src="<?php echo $key['imageSrc'] ?>" style="min-width: 220px; min-height: 160px; width: 100%; object-fit: cover; margin-top: 0px; position: relative; background: #FFFFFF center no-repeat;    height: 140px;" alt="Bachaa Party - Grand Summer Sale">
              <div class="px-2 py-3">
                <div class="">
                    <div class="" style="">
                        ...
                        <div class="flex flex-nowrap mt-1">
                            <div class="w-9/12">
                                <h3 class="truncate text-sm mt-1 font-semibold">{{$key['saleName']}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <p class=" text-sm mt-1" style=""><span style="color: #00745A">Post Time: {{$key['postDate']}}</span> </p>
        </div>
    </a>
</div>
@endforeach
            ...
            <div class="wrapper">
                <div>
                    <span class="font-semibold text-lg">Popular Categories</span>
                    <a href="<?php echo route('vallcatgpage') ?>" class="float-right mt-0.5">View All</a>
                </div>
                <div class="scrolls mt-2" style=" padding-top: 1.2em; padding-bottom: 1.2em">
                    @foreach($catglist as $key)
                        <a href="<?php echo $key['catglink']; ?>" class="mb-4 mr-1 rounded-full font-semibold" style="text-transform:capitalize; background: rgb(66 56 157 / 15%); padding: .6em 1em; color: #42389d;">
                            {{$key['catgname']}}
                        </a>
                        @endforeach
                    </div>
            ...
            <div>
                <div>
                    <span class="font-semibold text-lg">Popular Brands</span>
                    <!-- <a href="https://saleboard.pk/brands" class="float-right mt-0.5">View All</a> -->
                    <a href="<?php echo route('vallbrandspage') ?>" class="float-right mt-0.5">View All</a>
                </div> <div class="flex flex-wrap">
                 @foreach($popularbrandslist as $key)
                        <div class="xl:w-1/6 md:w-1/5 p-2 mb-2 homeBrandSection">
                            <a href="<?php echo route('vallsalesbybrandid', ['id' => substr($key['brandslink'],8)]) ?>">
                                <div class="border-0 shadow-lg rounded-lg">
                                    <div class="w-full inline-flex items-center justify-center bg-indigo-100 text-indigo-500 mb-4">
                                        <img class="h-48 w-full" src="<?php echo $key['brandsimage'] ?>" alt="Gul Ahmed's Sales, Promotions and Deals">

                                    </div>
                                    <h2 class="text-lg title-font mb-2 px-4 truncate font-semibold text-center" style="color: #42389d">{{$key['brandsname']}}</h2>
...
<script>
        $(".aiClick").click(function () {
            ...
            $.ajax({
                ...
                cache: false,
                headers: {
                    'X-CSRF-Token': '4BzzBXONuOvLlFvyCB1gm6SSeLxZIm0Z6pfQAVtj',
                },
...
<iframe id="_hjSafeContext_83864282" title="_hjSafeContext" tabindex="-1" aria-hidden="true" src="about:blank" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe><div id="pip-toast"></div></body></html>
